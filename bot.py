...
# Pairs with flags - displayed as big buttons
PAIRS = [
    "🇺🇸🇯🇵 USD/JPY OTC",
    "🇬🇧🇺🇸 GBP/USD OTC",
    "🇬🇧🇯🇵 GBP/JPY OTC",
...
async def signal_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # **Pairs as big keyboard buttons** - This is what you want
...
async def button_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data.startswith("pair_"):
        ...
        # Signal format similar to original
...
async def main():
    ...
    print("🚀 Bot running with Pair Keyboard Buttons")
