...
async def signal_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # Keyboard buttons at bottom (like Aether IQ)
    keyboard = [[pair] for pair in PAIRS]
    reply_markup = ReplyKeyboardMarkup(keyboard, resize_keyboard=True)
 
    await update.message.reply_text("📍 **Select Pair**", reply_markup=reply_markup, parse_mode="Markdown")
...
async def main():
    ...
    print("🚀 Bot running with Inline Keyboard")
